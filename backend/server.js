...
const { seedGuestUser } = require("./services/seedService");
...
// HEAD /health — for uptime monitors and load balancers (no body, just 200)
...
app.listen(PORT, async () => {
  ...
  // Seed default data (runs only if guest doesn't exist yet)
  await seedGuestUser();
});
